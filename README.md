...
사용자의 키보드, 마우스 클릭, 마우스 이동 이벤트를 백그라운드에서 수집하며, 실시간 그래프 모니터링 기능을 제공합니다.

---

## 📥 다운로드 및 설치 (Download)

아래 링크를 클릭하여 최신 설치 프로그램(`HAR_Sensor_Setup.exe`)을 다운로드하세요.

👉 **[최신 버전 다운로드 (Click Here)](https://github.com/janghyunroh/KM-TRACK/releases/latest/download/HAR_Sensor_Setup.exe)**
